...
public class ConfigRuntimeException extends RuntimeException
{
     ...
     */
    public ConfigRuntimeException(final String message, final Object... args)
    {
     ...
     */
    public ConfigRuntimeException(final Throwable cause)
    {
        super(cause);
    }
     ...
     * @param cause    the exception or error that caused this exception to be thrown
     */
    public ConfigRuntimeException(final String message, final Throwable cause)
    {
        super(message, cause);
    }
}
